            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('admin.faq.categories.index')"
                                    :active="request()->routeIs('admin.faq.categories.*')">
                            FAQ Categorieën
                        </x-nav-link>

                        <x-nav-link :href="route('admin.faq.items.index')"
                                    :active="request()->routeIs('admin.faq.items.*')">
                            FAQ Items
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('admin.log-mails.index')" :active="request()->routeIs('admin.log-mails.index')">
                            Gelogde mails
                        </x-nav-link>
